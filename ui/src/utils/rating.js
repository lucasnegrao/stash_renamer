...
export const defaultRatingSystemType = RatingSystemType.Stars;
export const defaultRatingStarPrecision = RatingStarPrecision.Full;
export const ratingSystemIntlMap = new Map([
    [
...
export const ratingStarPrecisionIntlMap = new Map([
    [
...
export function getRatingPrecision(precision) {
    switch (precision) {
...
export function convertToRatingFormat(rating, ratingSystemOptions) {
    if (!rating) {
        return null;
    }
...
export function convertFromRatingFormat(rating, ratingSystem) {

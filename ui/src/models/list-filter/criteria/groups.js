...
export const GroupsCriterionOption = new BaseGroupsCriterionOption("groups", "groups");
export class GroupsCriterion extends IHierarchicalLabeledIdCriterion {
}
export const ContainingGroupsCriterionOption = new BaseGroupsCriterionOption("containing_groups", "containing_groups");
export const SubGroupsCriterionOption = new BaseGroupsCriterionOption("sub_groups", "sub_groups");

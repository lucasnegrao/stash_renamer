...
export class ModifierCriterionOption extends CriterionOption {
    constructor(options) {
        ...
        this.defaultModifier = (_b = options.defaultModifier) !== null && _b !== void 0 ? _b : CriterionModifier.Equals;
...
export function createMandatoryNumberCriterionOption(value, messageID, options) {
...
export class DurationCriterion extends ModifierCriterion {
    ...
    getLabelValue(_intl) {
        var _a, _b;
        const value = TextUtils.secondsToTimestamp((_a = this.value.value) !== null && _a !== void 0 ? _a : 0);
        const value2 = TextUtils.secondsToTimestamp((_b = this.value.value2) !== null && _b !== void 0 ? _b : 0);
        if (this.modifier === CriterionModifier.Between ||
            this.modifier === CriterionModifier.NotBetween) {
            return `${value}, ${value2}`;
        }
